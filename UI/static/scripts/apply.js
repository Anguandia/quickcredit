...
<form id='loanform' action=''>\
  <fieldset class='loanform'>\
    ...
    <input type='text' name='family_name' id='family_name'\ placeholder='family name' oninvalid='this.setCustomValidity("sur name is required")'\ required></input>\
    </label>\
    <label class='loan_app'>First Name<span>*</span>\
        <input type='text' name='first_name' id='first' placeholder='first name'\ oninvalid='this.setCustomValidity("first name is required")' required></input>\
    </label>\
  </fieldset><br>\
  <fieldset class='loanform'>\
