...
let loandetail = document.getElementById('loandetail');
dt.innerHTML = `<h3 class='user debit_loan view_loan'>Loan Transaction Log - ${localStorage.getItem('role')=='Client'?localStorage.getItem('current user'): 'Anguandia Mike'}</h3><hr class='user debit_loan view_loan'>\
...
loandetail.insertBefore(dt, loandetail.children[3]);
